...
var consnesus_asset_path="users/iec2019002/consensus/Rainfed_Broadleaf_Cropland"
var reprojected_asset_path="users/iec2019002/reprojected2/Rainfed_Broadleaf_Cropland_2240m"
...
switch(task) {
    ...
    case "Exportation":
      print("The executed task is the exportation only")
        ...
        Export.image.toAsset({
          ...
          description: 'Rainfed_Broadleaf_Cropland',
          //crs: proj.crs,
    ...
    case "Reprojection":
      ...
      var World =  ee.Geometry.Polygon(
        ...
        Export.image.toAsset({
          image: reproj_image, 
          description: 'Rainfed_Broadleaf_Cropland_2240m',
          //crs: proj.crs,
          //crsTransform: transform_new,
          scale: proj,
          maxPixels: 1e13,
