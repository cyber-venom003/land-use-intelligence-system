...
var consnesus_asset_path="users/lareb/consensus/Forest_ODN"
var reprojected_asset_path="users/lareb/reprojected2/Forest_ODN_2240m"
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
//
//                        Useful function
...
switch(task) {
    case "Exportation":
      print("The executed task is the exportation only")
        ...
        Export.image.toAsset({
          ...
          description: 'consensus/Forest_ODN',
          //crs: proj.crs,
    ...
    case "Reprojection":
      ...
      var World =  ee.Geometry.Polygon(
        ...
        Export.image.toAsset({
          image: reproj_image, 
          description: 'reprojected2/Forest_ODN_2240m',
          //crs: proj.crs,
          //crsTransform: transform_new,
          scale: proj,
          maxPixels: 1e13,
