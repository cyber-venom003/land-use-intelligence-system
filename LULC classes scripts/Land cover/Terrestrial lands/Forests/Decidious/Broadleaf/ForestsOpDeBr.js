...
var consnesus_asset_path="users/iec2019002/consensus/Forest_ODB"
var reprojected_asset_path="users/iec2019002/reprojected2/Forest_ODB_2240m"
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
//
//                        Useful function
...
var ModisIgbpODB1 = datamask1.eq(4)
var dataset2 = ee.Image('MODIS/006/MCD12Q1/2018_01_01');
var datamask2 = dataset2.select('LC_Type4').unmask(0);
var ModisIgbpODB2 = datamask2.eq(4)
var dataset3 = ee.Image('MODIS/006/MCD12Q1/2019_01_01');
var datamask3 = dataset3.select('LC_Type4').unmask(0);
var ModisIgbpODB3 = datamask3.eq(4)
var ModisODB4=ModisIgbpODB3.add(ModisIgbpODB2.add(ModisIgbpODB1))
ModisODB4=ModisODB4.divide(3)
Map.addLayer(ModisODB4,{min: 0, max: 1,format:'jpg'},'Modis4ODB',false);
...
var ModisIgbpODB3 = datamask3.eq(4)
var ModisODB5=ModisIgbpODB3.add(ModisIgbpODB2.add(ModisIgbpODB1))
ModisODB5=ModisODB5.divide(3)
Map.addLayer(ModisODB5,{min: 0, max: 1,format:'jpg'},'Modis5ODB',false);
var Modis45ODB = ModisODB5.add(ModisODB4)
Map.addLayer(Modis45ODB,{min: 0, max: 2,format:'jpg'},'Modis45ODB',false);
...
var COPERNICUSODB1_tree_cover =datamask1_tree_cover.gte(15).and(datamask1_tree_cover.lte(30));
var COPERNICUSODB1_forest_type =datamask1_forest_type.eq(4);
var COPERNICUSODB1=COPERNICUSODB1_tree_cover.add(COPERNICUSODB1_forest_type)
...
var COPERNICUSODB2_tree_cover =datamask2_tree_cover.gte(15).and(datamask2_tree_cover.lte(30));
var COPERNICUSODB2_forest_type =datamask2_forest_type.eq(4);
var COPERNICUSODB2=COPERNICUSODB2_tree_cover.add(COPERNICUSODB2_forest_type)
...
var COPERNICUSODB3_tree_cover =datamask3_tree_cover.gte(15).and(datamask3_tree_cover.lte(30));
var COPERNICUSODB3_forest_type =datamask3_forest_type.eq(4);
var COPERNICUSODB3=COPERNICUSODB3_tree_cover.add(COPERNICUSODB3_forest_type)

var COPERNICUSODB=COPERNICUSODB3.add(COPERNICUSODB2.add(COPERNICUSODB1))
COPERNICUSODB=COPERNICUSODB.divide(3)
Map.addLayer(COPERNICUSODB,{min: 0, max: 2,format:'jpg'},'COPERNICUSODB',false);
var ModisCOPERNICUSODB = COPERNICUSODB.add(Modis45ODB)
Map.addLayer(ModisCOPERNICUSODB,{min: 0, max: 4,format:'jpg'},'ModisCOPERNICUSODB',false);

///////////////////////////// Seventh Dataset ////////////////////////////////
var image = ee.Image('ESA/GLOBCOVER_L4_200901_200912_V2_3');
var datamask =  image.select('landcover').unmask(0);
var GLOBCOVERODB =datamask.eq(60)////white=ODB black=others
Map.addLayer(GLOBCOVERODB,{min: 0, max: 1,format:'jpg'},'GLOBCOVERODB',false);
var GLOBCOVERModisCOPERNICUSODB = GLOBCOVERODB.add(ModisCOPERNICUSODB)
Map.addLayer(GLOBCOVERModisCOPERNICUSODB,{min: 0, max: 5,format:'jpg'},'GLOBCOVERModisCOPERNICUSODB',false);
...
var PALSARGLOBCOVERModisCOPERNICUSODB = PALSAR.add(GLOBCOVERModisCOPERNICUSODB)
Map.addLayer(PALSARGLOBCOVERModisCOPERNICUSODB,{min: 0, max: 6,format:'jpg'},'PALSARGLOBCOVERModisCOPERNICUSODB',false);

///////////////////////////// Eleventh Dataset ///////////////////////////
var image = ee.Image("UMD/hansen/global_forest_change_2019_v1_7");
var datamask1 = image.select('treecover2000').unmask(0);
var HansenForestODB1 =datamask1.gte(15).and(datamask1.lte(30))////white=Forest black=others
var datamask2 = image.select('loss').unmask(999);
var HansenForestODB2 =datamask2.eq(0)////white=Forest black=others
var datamask3 = image.select('gain').unmask(999);
var HansenForestODB3 =datamask3.eq(0)
var datamask4 = image.select('datamask').unmask(999);
var Hansen4 =datamask4.neq(2)
var HansenForestODB = HansenForestODB1.and(HansenForestODB2.and(HansenForestODB3.and(Hansen4)))
Map.addLayer(HansenForestODB,{min: 0, max: 1,format:'jpg'},'HansenForestODB',false);
var HansenPALSARGLOBCOVERModisCOPERNICUSODB = HansenForestODB.add(PALSARGLOBCOVERModisCOPERNICUSODB)
Map.addLayer(HansenPALSARGLOBCOVERModisCOPERNICUSODB,{min: 0, max: 7,format:'jpg'},'HansenPALSARGLOBCOVERModisCOPERNICUSODB',false);

///////////////////////////// Twelvth Dataset ///////////////////////////
var image = ee.Image('NASA/JPL/global_forest_canopy_height_2005');
var datamask = image.select('1').unmask(0);
var GFCHODB=datamask.gte(2)
Map.addLayer(GFCHODB,{min: 0, max: 1,format:'jpg'},'GFCHODB',false);
var GFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB = GFCHODB.add(HansenPALSARGLOBCOVERModisCOPERNICUSODB)
Map.addLayer(GFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB,{min: 0, max: 8,format:'jpg'},'GFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB',false);
...
var GFCC = c;
Map.addLayer(GFCC,{min: 0, max: 1,format:'jpg'},'GFCCODB',false);
var GFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB = GFCC.add(GFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB)
Map.addLayer(GFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB,{min: 0, max: 9,format:'jpg'},'GFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB',false);
...
var JRCGFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB =GFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB.multiply(JRC)
Map.addLayer(JRCGFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB,{min: 0, max: 9,format:'jpg'},'JRCGFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB',false);
...
var ODBwithoutWater = JRCM.multiply(JRCGFCCGFCHHansenPALSARGLOBCOVERModisCOPERNICUSODB)
Map.addLayer(ODBwithoutWater,{min: 0, max: 9,format:'jpg'},'ODBwithoutWater',false);

ODBwithoutWater=ODBwithoutWater.divide(9)
Map.addLayer(ODBwithoutWater,{min: 0, max: 1,format:'jpg'},'ODB_addition_divided_by_9',false);
...
ODBwithoutWater=ODBwithoutWater.multiply(Tsinghua); 
Map.addLayer(ODBwithoutWater,{min: 0, max: 1,format:'jpg'},'ODBwithoutWater_without_urban',false);
...
switch(task) {
    case "Exportation":
      print("The executed task is the exportation only")
        ...
        var proj = ODBwithoutWater.projection().nominalScale().getInfo();
          
        Export.image.toAsset({
          image: ODBwithoutWater, 
          description: 'consensus/Forest_ODB',
          //crs: proj.crs,
    ...
    case "Reprojection":
      ...
      var World =  ee.Geometry.Polygon(
        ...
        Export.image.toAsset({
          image: reproj_image, 
          description: 'reprojected2/Forest_ODB_2240m',
          //crs: proj.crs,
          //crsTransform: transform_new,
          scale: proj,
          maxPixels: 1e13,
    ...
    case "Processing":
        ...
        Map.addLayer(image,{min: 0, max: 1,format:'jpg'},'Forest_ODB_2240m_Asset_image',false);
        ...
        var pixel_value = function(f){
          ...
          f = f.set('land_cover_class', "Forest_ODB");
        ...
        var filename='coordinates_Forest_ODB'
