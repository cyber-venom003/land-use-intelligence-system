...
var consnesus_asset_path="users/iec2019002/consensus/Continental_Water"
var reprojected_asset_path="users/iec2019002/reprojected2/Continental_Water_2240m"
...
switch(task) {
    ...
    case "Reprojection":
      ...
      var World =  ee.Geometry.Polygon(
        ...
        Export.image.toAsset({
          image: reproj_image, 
          description: 'Continental_Water_2240m',
          //crs: proj.crs,
          //crsTransform: transform_new,
          scale: proj,
          maxPixels: 1e13,
